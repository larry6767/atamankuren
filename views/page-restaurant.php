    ...
    <section class="restaurants-menu">
      ...
      <div class="restaurants-menu__list-wrapper">
        <div class="restaurants-menu__list">
          ...
          <?php
          $restaurant_category = 'cat=' . ((int)get_field('restaurant_category') + 3 );
          if ( have_posts() ) : query_posts($restaurant_category);
            while ( have_posts() ) : the_post(); ?>

            <a href="<?php echo get_field('restaurant_pdf'); ?>" target="_blank" class="restaurants-menu__link">
              ...
              <?php echo get_field('restaurant_link_text'); ?>
            </a>
